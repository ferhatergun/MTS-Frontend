...
export default function Comments() {
  ...
  return (
    <div>
        <div className={styles.commnetCreateDiv}>
            ...
            <div className={styles.allCommentsDiv}>
                ...
                <div className={styles.commentDiv}>
                    ...
                    <div className={styles.commentBottom}>
                        <div className={styles.commentIcon}><ThumbUpOffAltIcon className={styles.Icon} />15</div>
                        <div className={styles.commentIcon}><ThumbDownOffAltIcon className={styles.Icon} />4</div>
                        <div className={styles.commentIcon}><ModeCommentOutlinedIcon className={styles.Icon} />Cevapla</div>
                        <div className={styles.commentIconn}
                        onClick={handleClick}
                        ><MoreVertIcon className={styles.Icon} /></div>
